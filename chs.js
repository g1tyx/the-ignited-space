...
var cnItems = {
    ...
    "Platinum tools": "铂金工具",
    "Platinum tools provides additional production boost to your wood and crafting beams, plates and bricks": "铂金工具为您的木材和工艺梁、金属板和砖块提供额外的生产提升",
    "Rubber Details": "橡胶细节",
    "Sealing": "密封",
    ...
    "Laser Cutting": "激光切割",
    "Laser Cutting of metal parts significantly simplifies plates and wires production": "金属零件的激光切割显着简化了金属板和线材的生产",
    "Last Loot": "最后战利品",
    ...
    "Using lasers to cut out metal parts significantly simplifies plates and wires production": "使用激光切割金属零件可显着简化金属板和线材的生产",
    ...
    "Better understanding of quantum physics can significantly boost the productivity of your civilization": "更好地理解量子物理学可以显着提高你的文明的生产力",
    "Bio Laboratory": "生物实验室",
    ...
    "Using computers for diagnostics can significantly improve healthcare services. Each level increases healthcare from clinics by 5%": "使用计算机进行诊断可以显着改善医疗保健服务。 每个级别增加 5% 的诊所医疗保健",
    ...
    "Using 3D printers in creating organs to heal people can significantly boost healthcare, but religious people won't like it": "使用 3D 打印机制造器官来治愈人类可以显着促进医疗保健，但宗教人士不会喜欢它",
    ...
    "Using lasers to cut out metal parts significantly simplifies plates and wires production. Increased plate and wire production by 10%": "使用激光切割金属零件可以显着简化金属板和线材的生产。 金属板和线材产量增加 10%",
    ...
    "Low temperatures can significantly reduce molecule decay rates. Learn how to use it to generate more sophisticated organics": "低温可以显着降低分子衰变率。 了解如何使用它来生成更复杂的有机物",

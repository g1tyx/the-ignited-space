...
var cnItems = {
    ...
    "Small space station that provides some entertainment and aesthetics to your people": "为您的人民提供娱乐和美观度加成的小型空间站",
    ...
    "Consumes huge amount of power, but provides significant research capacity": "消耗大量电力，但提供大量的的研究上限",
    ...
    "Further advance biology knowledge. Create new methods of boosting nutritional value and unlock new research": "进一步钻研生物学知识。创造提高营养价值的新方法并开启新的研究",
    ...
    "Allow All": "全部允许",
    "Using experimental medicine reduces healthcare from clinics, but they also provide a boost to max research": "使用实验性医学会降低诊所的医疗保健加成，但它们也将提供研究上限",
    "Water Filtering Control": "水过滤控制",
    "Changes the water filtration method": "改变水过滤方法",
    "Quick": "快的",
    "Water pumps are working in regular way": "水泵正常工作",
    "Multi-Stage": "多级",
    "Water pumps consume twice as much power, but increase healthcare by 3 each": "水泵消耗两倍的功率，但每座水泵使医疗保健增加 3",
    "Research Focus": "研究重点",
    "Setting research as priority through providing better equipment to your scientists can boost the development of your colony, but it won't be cheap": "将科研置于发展的首位，可以促进你的殖民地的发展，但也需要付出代价",
    "No Extra Support": "无额外支持",
    "Science buildings operate normally": "科学建筑正常运行",
    "Minor Support": "少量支持",
    "Grant your scientists better tools to work with. Science buildings consume 25% more power, but provide 5% more research capacity": "为您的科学家提供更好的工作工具。地面科学建筑消耗额外 25% 的电力，但提供额外 5% 的研究上限",
    "Major Support": "大量支持",
    "Grant your scientists state-of-the-art tools to work on prototypes. Science buildings consume 75% more power, but provide 10% more research capacity": "为您的科学家提供最先进的工具来处理原型。地面科学建筑消耗额外 75% 的电力，但提供额外 10% 的研究上限",
    "Forest Use": "森林利用",
    ...
    "Extra Rations": "额外口粮",
    "Incentivize your police force to work better with extra rations. Policemen consume extra 0.5 nutrition and 0.2 water each, but provide a better service": "激励你的警察部队用额外的口粮更好地工作。警察每人每秒额外消耗 0.5 营养物质和 0.2 水，但提供更高的安保加成",
    ...
    "Encourage production at the cost of pretty landscape. Foresters produce 20% more wood, but each forester reduces aesthetics by 1.5": "以美丽的风景为代价鼓励生产。林务员的木材产量提升 20%，但每个林务员减少 1.5 美观度",
    "Forest Preservation": "森林保护",
    "Encourage limited cutting and frequent replanting. Foresters produce 20% less wood, but each forester increases aesthetics by 1": "鼓励有限的砍伐和频繁的重新种植。林务员的木材产量降低 20%，但每个林务员增加 1 美观度",
    ...
    "Time to inflict another industrial revoluion. Thermal plants are 25% more efficient, but consume 0.03 wood each": "是时候发动另一场工业革命了。热力发电厂的效率提升 25%，但每每座热力发电厂每秒需消耗 0.03 木材",
    ...
    "Process food to increase shelf life and nutritional value at the cost of its quality. Provides 10% bonus to nutrition production, but decrease healthcare by 10%": "加工食品，以牺牲其质量为代价，延长保质期和营养价值。营养物质产量提升 10%，但医疗保健降低 10%",
    "Smelting Method": "冶炼法",
    ...
    "Allow your Biolabs to run orbital research expeditions.": "允许您的生物实验室在外层轨道上进行深度的研究。",
    "Forbid": "禁止",
    ...
    "Knowledge: Healthcare Consumption": "知识：医疗保健消耗",
    ...
    "Produce": "生产",
    "Storage Bonuses": "上限加成",
    "Hold Ctrl to set 0": "按住Ctrl键设置 0",
...
>>>>>>> parent of 6b7b988 (Update chs.js)
    ...
    "XP Gain: x": "经验点数倍率：x",
    "Weather: x": "天气倍率：x",
    "Select search for specific modifier. This will increase search cost": "搜索特定的行星词缀。这会增加搜索行星时的燃料消耗",
    "None": "无",
    "None": "无",
    ...
    "Total KP Gain (All time)": "总知识点获取",
    "Max KP Gain (per prestige)": "历史最高知识点获取（单次重置）",

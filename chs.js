...
var cnItems = {
    ...
    "Fuel Purification Mode": "燃料纯化模式",
    "Control technical process of fuel purification": "控制燃料纯化过程的技术规范",
    "Safe & Harmless": "安全无害",
    "Fuel Purification Stations running as normally": "燃料纯化站以正常的方式工作",
    "Intensive Bacteria Usage": "密集使用细菌",
    "Use fuel purification bacteria more aggressively. Boosts power generation by thermonuclear power plants even further, but produces a lot of annoying smell. Doesnt hurt anyone, but reduce aesthetics": "激进地使用燃料纯化站。燃料纯化站对热核发电站的加成提升 2%，但会排放恶臭的气味。这不会伤害任何人，但会降低美观",
    "Uncontrolled Bacteria Usage": "无限使用细菌",
    "Use fuel purification bacteria is pretty much unlimited. Dramatically reduce aesthetics. How your people even bear it?": "毫无顾忌地使用燃料纯化站。燃料纯化站对热核发电站的加成提升 4%，但会大幅降低美观。……这个味道谁受得了啊？",
    ...
    "Magnetic Field Generation": "磁场发生器模式",
    "Change mode of magnetic field generation at your magnetic press": "改变电磁压力机产生磁场的方式",
    "Conservative": "保守",
    "Magnetic field is generated as materials production and refinement needs it": "只有当生产需要时才产生电磁场",
    "Experimental": "实验性",
    "Magnetic Press using intensive magnetic field to provoke more active creation of matter-antimatter pair, starting boosting Antimatter Lab more significantly but consuming even more power": "电磁压力机使用强磁场来激发更多物质-反物质对的产生，为反物质实验室提供额外 2% 的研究上限，但需要消耗更多的电力",

...
var cnItems = {
    ...
    "Increase stone, ore and biomass storage from storage section and hub by 25%": "存储区域和存储中心的石头、矿石和生物质储量提升 25%",
    "Reserve batteries": "备用电池",
    "Storage Bonuses": "存储加成",
    "Storage technology": "存储技术",
    "Thermoelectric plants now also provide small power storage": "热电厂现在也提供少量电力储量",
    "Water pumping": "抽水",
    "Water": "水",
    ...
    "Improves your stone, ore and biomass storage facilities by 50%.": "石头、矿石和生物质储量提升 50%。",
    ...
    "Provides 25 science storage and boost science output by 2% multiplicative": "提供 25 研究点储量，并乘算提升 2% 研究点输出",
    "Provides basic healthcare service": "提供基本的医疗服务",
    "Provides even more science storage and boost science output by 5% multiplicative": "提供更多的研究点储量，并将研究点产出提高 5%",
    ...
    "Plate": "金属板",
    "Provides more raw materials storage": "提供更多的基础材料储量",
    ...
    "Provides 5% bonus to your materials storage in warehouses": "仓库的储量提升 5%",
    ...
    "Provides additional science capacity and generation": "提供额外的研究点储量和产量",
    ...
    "Science buildings consume 150% more electricity but provide 10% more science capacity": "地面科学建筑额外消耗 150% 的电力，但提供额外 10% 的研究点储量",
    "Science buildings consume 50% more electricity but provide 5% more science capacity": "地面科学建筑额外消耗 50% 的电力，但提供额外 5% 的研究点储量",
    ...
    "Using experimental medicine reduces healthcare efficiency of clinics, but they now provide some max research boost": "使用实验性医学会降低诊所的医疗加成，但能令其提供少量的研究点储量",
    ...
    "Allows you building containers that providing boost to your storage capacity": "允许您建造能提高仓库储量的存储容器",
    ...
    "Laser Cutting": "激光切割",
    "Laser Cutting of metal parts significantly simplifies plates and wires production": "金属零件的激光切割显著简化了金属板和线材的生产",
    "Last Loot": "最后战利品",
    ...
    "Using lasers to cut out metal parts significantly simplifies plates and wires production": "使用激光切割金属零件可显著简化金属板和线材的生产",
    ...
    "Fixed bug when locked resources still were displaying in bonuses or requirements list": "修复了锁定资源仍然显示在奖励或需求列表中的错误",
    ...
    "Using computers for diagnostics can significantly improve healthcare services. Each level increases clinic efficiency by 5%": "使用计算机进行诊断可以显著改善医疗保健服务。 每级提高诊所效率5%",
    ...
    "Every point boost beam, brick and plate production by 4%": "每点提升梁、砖和金属板产量 4%",
    ...
    "Added notifications for new buildings/upgrades/laws": "添加了新建筑/升级/法令的通知",
    ...
    "Hide resources": "隐藏资源",
    "Added mobile support (Experimental and might be buggy)": "添加了移动支持（实验性的，可能有问题）",
    "Items that require more capacity are now highlighted differently": "需要更多容量的项目现在以不同方式突出显示",
    "": "",
    "v0.0.3b Mobile friendly UI version": "v0.0.3b 移动端友好界面版本",
    "\"Foresters produce a normal amount of wood": "\“林务员生产正常数量的木材",
    "A zone with rich greenery provides a way to relax for your people": "绿意盎然的区域为您的员工提供放松的方式",
    "Add few new researches and buildings": "添加一些新的研究和建筑物",
    "Added +/-5 controls for jobs and crafters": "为工作和工匠添加了 +/-5 控制",
    "Added highlight for buildings that use howered resource": "为使用 howered 资源的建筑物添加了亮点",
    "Administrative Service Center": "行政服务中心",
    "Advanced Metallurgy": "先进冶金",
    "Advanced Water Filtering": "先进的水过滤",
    "Aggressive Cutting": "强力切割",
    "All food is grown organically and served unprocessed": "所有食物都是有机种植的，未经加工就可以食用",
    "Allow All": "允许全部",
    "Allow or forbid wood usage as coal": "允许或禁止木材用作煤炭",
    "Allow using a minor amount of wood for thermal plants. Thermal plants are 10% more efficient, but consume 0.01 wood each": "允许为热电厂使用少量木材。 热电厂的效率提高 10%，但每台消耗 0.01 根木材",
    "Automate some mundane tasks of your artisans. Gain 5% bonus to all crafting": "自动化您的工匠的一些平凡任务。 所有手工艺品获得 5% 奖励",
    "Automatically collects ore": "自动收集矿石",
    "Automatically collects stone": "自动收集石头",
    "Automatically produces biomass": "自动生产生物质",
    "Better understanding of quantum physics can significantly boost the productivity of your civilization": "更好地理解量子物理学可以显著提高你的文明的生产力",
    "Bio Laboratory": "生物实验室",
    ...
    "Expedition button now on the top": "远征按钮现在位于顶部",
    "Extra Rations": "额外口粮",
    ...
    "Rerout extra energy toward terrain scanners of your expedition drones. Increases expedition loot by 30%": "将额外的能量重新分配给探险无人机的地形扫描仪。 远征战利品增加 30%",
    ...
    "Increased \"Expeditions\" rewards": "增加“远征”奖励",

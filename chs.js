...
var cnItems = {
    ...
    "This hostile and hot planet, literally made of iron will remind your people of the god of the Underground. Requires a lot resources, but provides significant motivation to religious people": "这颗环境恶劣的炎热星球完全是由铁组成的，看到它会让你的人民想起以前的地底之神。在这里建造纪念碑需要大量资源，但它将成为宗教人士的精神支柱",
    "Flora Plant": "植物群系",
    ...
    "Rocket Mastery": "火箭精通",
    "Each space colony starts with a rocket trip, and you are good at making rockets. Every point boosts fuel and rockets production by 4%": "每个太空殖民地都从一次火箭之旅开始，而你刚好十分擅长制造火箭。每级使燃料和火箭产量增加 4%",
    ...
    "Entertainment Consumption": "娱乐消耗",
    "You are not easily bored and know how to distract people from boredom. Every point decreases entertainment requirements by 4": "你不容易感到无聊，并且知道如何消解人们的无聊感。每级使娱乐消耗降低 4",
    "Religion Consumption": "宗教消耗",
    ...
    "Forest Use": "森林利用法案",
    "Your forest plants can be used in different ways to provide various advantages": "你能以多种方式利用森林，以提供各种加成",
    ...
    "Extra Rations": "额外口粮",
    "Incentivize your police force to work better with extra rations. Policemen consume extra 0.5 nutrition and 0.2 water each, but provide a better service": "激励你的警察部队，用额外的口粮更好地工作。警察每人每秒额外消耗 0.5 营养物质和 0.2 水，但提供更高的安保加成",
    ...
    "You start with broken ship on hostile planet. Your main goal is to prepare for first colonists to arrive, and build prosperous civilisation": "你身处一颗环境恶劣的星球，开始时身边只有一艘破损的飞船。你的主要目标是为第一批殖民者的到来做好准备，并逐步建设起繁荣的文明。",
    ...
    'Distances between stars used to be incredibly huge. For example, the distance to Proxima Centauri from Earth is approximately 39.7 trillion kilometers or 4.24 light-years. That\'s why human very unlikely visit other star systems in near future. But its not the case once you are playing "The Ignited Space"': "恒星之间的距离是非常远的。例如，地球到比邻星的距离约为 39.7 万亿公里，或者说 4.24 光年。这就是为什么人类在短时间内不太可能访问其他恒星系统。但当你玩“激燃太空”时，事情就不是这样了！",
    "Loading...": "加载中...",
    "Did you knew?": "你知道吗？",
    "Show Resources": "显示资源",
    "Hide resources": "隐藏资源",

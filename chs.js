...
var cnItems = {
    ...
    "Repair storage module. Allows building storage sections": "修理存储模块。 允许建造存储部分",
    "Bacteria Incubator": "细菌培养箱",
    ...
    "Added highlight on missing resource when hower over building/upgrade/research": "在建造/升级/研究过程中添加了对丢失资源的突出显示",
    ...
    "Allows you building containers that providing boost to your storage capacity": "允许您建造可提高存储容量的容器",
    ...
    "Refined materials lie at the core of all complex structures. Every point boosts beam, brick and plate production by 4%": "精制材料是所有复杂结构的核心。 每一点都会使梁、砖和板材的产量提高 4%",
    ...
    "Using lasers to cut out metal parts significantly simplifies plates and wires production. Increased plate and wire production by 10%": "使用激光切割金属零件可以显着简化板材和线材的生产。 板材和线材产量增加 10%",
    "Create platinum tools to provide additional production boost. Increases wood production and beam, brick and plate crafting by 10%": "创建白金工具以提供额外的产量提升。 木材产量以及梁、砖和板材制作增加 10%",
    ...
    "Use hot ionized gas to cut metal. Improves plates, wires and rockets output by 10%": "使用热电离气体切割金属。 将板材、线材和火箭产量提高 10%",
    ...
    "Using composite metals allows to increase crafting output for plates and wires by 20%": "使用复合金属可以将板材和线材的制作产量提高 20%",

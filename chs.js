...
var cnItems = {
    ...
    "Learn how to create well-focused quark-gluon stream to destroy your enemies. Unlocks new weapons": "学习如何制造精准的夸克-胶子流，用于摧毁你的敌人。解锁新武器",
    ...
    "Use bose-einstein condensate based lasers to generate almost ideally focused and coherent photonics beam. Improves all electronics output by 20%": "使用基于玻色-爱因斯坦凝聚的激光器，产生几乎完全聚焦和相干的光子束。使所有电子产品产量提高 20%",
    ...
    "Absolute Zero": "绝对零度",
    "Added new late game content: buildings, resources, researches": "添加了新的后期游戏内容：建筑物、资源、研究",
    "Added specific highlight to upgrades unlocking buildings/researches": "添加了升级解锁建筑物/研究的具体亮点",
    "Building": "建筑",
    "Events": "事件",
    "Exotic Matter Collected": "收集到的奇异物质",
    "Hold Q to add item into queue": "按住 Q 将项目添加到队列中",
    "Implemented event log": "实施事件日志",
    "Implemented queue for buildings/researches": "为建筑物/研究实施队列",
    "Queue": "队列",
    "Queue is full": "队列已满",
    "Select scope first": "首先选择范围",
    "Undefined": "不明确的",
    "Update some buildings and techs requirements": "更新一些建筑和技术要求",
    "Upgrade": "升级",
